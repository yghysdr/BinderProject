...
@Override public int getApplePrice() throws android.os.RemoteException
{
...
@Override public com.github.yghysdr.server.aidl.Apple getApple() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
